...
BASE_CONFIG_FILE="/proj/eta-automation/tapas/config/invoicing/suites/washingmachine_blame.xml"
CONFIG_FILE="/proj/eta-automation/tapas/sessions/invoicing/washingmachine_blame_${BUILD_NUMBER}.xml"
