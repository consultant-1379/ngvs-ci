...
BASE_CONFIG_FILE="/proj/eta-automation/tapas/config/mapt/suites/washingmachine_blame.xml"
CONFIG_FILE="/proj/eta-automation/tapas/sessions/mapt/washingmachine_blame_${BUILD_NUMBER}.xml"
