...
BASE_CONFIG_FILE="/proj/eta-automation/tapas/config/cpm/suites/installnode/washingmachine_blame.xml"
CONFIG_FILE="/proj/eta-automation/tapas/sessions/cpm/washingmachine_blame_${BUILD_NUMBER}.xml"
