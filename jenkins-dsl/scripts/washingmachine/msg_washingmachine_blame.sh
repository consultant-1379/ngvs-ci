...
BASE_CONFIG_FILE="/proj/eta-automation/tapas/config/msg/suites/washingmachine_blame.xml"
CONFIG_FILE="/proj/eta-automation/tapas/sessions/msg/washingmachine_blame_${BUILD_NUMBER}.xml"
BUILDDESC=`echo ${UPDATE}`
export BUILDDESC

mkdir -p /proj/eta-automation/tapas/sessions/msg
