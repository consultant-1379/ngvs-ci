...
BASE_CONFIG_FILE="/proj/eta-automation/tapas/config/eps/suites/washingmachine_blame.xml"
CONFIG_FILE="/proj/eta-automation/tapas/sessions/eps/washingmachine_blame_${BUILD_NUMBER}.xml"
