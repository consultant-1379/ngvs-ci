...
BASE_CONFIG_FILE="/proj/eta-automation/tapas/config/taxation/suites/washingmachine_blame.xml"
CONFIG_FILE="/proj/eta-automation/tapas/sessions/taxation/washingmachine_blame_${BUILD_NUMBER}.xml"
...
--define=__SESSION_TIMESTAMP__=${SESSION_TIMESTAMP} \
