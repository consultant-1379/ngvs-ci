...
BASE_CONFIG_FILE="/proj/eta-automation/tapas/config/rmca/suites/washingmachine_blame.xml"
CONFIG_FILE="/proj/eta-automation/tapas/sessions/rmca/washingmachine_blame_${BUILD_NUMBER}.xml"
