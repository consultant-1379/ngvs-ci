...
sed -i "/sut.host=/c\sut.host=${TARGETHOSTIP}" nfnt/eftf.user.properties nfnt/eftf_test.properties
sed -i "/sim.url=/c\sim.url=${SIMIP}" nfnt/eftf.user.properties nfnt/eftf_test.properties
