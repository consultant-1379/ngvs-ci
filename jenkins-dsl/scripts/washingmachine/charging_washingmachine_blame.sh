...
BASE_CONFIG_FILE="/proj/eta-automation/tapas/config/charging/suites/installnode/washingmachine_blame.xml"
CONFIG_FILE="/proj/eta-automation/tapas/sessions/charging/washingmachine_blame_${BUILD_NUMBER}.xml"
