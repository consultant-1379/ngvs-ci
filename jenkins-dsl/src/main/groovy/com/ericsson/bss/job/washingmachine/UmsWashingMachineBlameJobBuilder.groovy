...
class UmsWashingMachineBlameJobBuilder extends AbstractWashingMachineBlameJobBuilder {
    ...
    protected void prepareParameters() {
        job.with {
            parameters {
                ...
                stringParam('DEFAULT_RECIPIENTS', 'ums_washingmachine@mailman.lmera.ericsson.se',
                        'Comma separated list of e-mail addresses that will always get the blame mail')
                stringParam('BLAME_CONFIG_FILE', '/proj/eta-automation/tapas/config/ums/config/blame/general-blame-config.json,' +
