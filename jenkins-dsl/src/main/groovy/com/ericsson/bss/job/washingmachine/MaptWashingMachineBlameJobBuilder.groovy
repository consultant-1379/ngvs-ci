...
class MaptWashingMachineBlameJobBuilder extends AbstractWashingMachineBlameJobBuilder {
    ...
    protected void prepareParameters() {
        job.with {
            parameters {
                ...
                stringParam('BLAME_CONFIG_FILE', '/proj/eta-automation/tapas/config/mapt/config/blame/general-blame-config.json,' +
