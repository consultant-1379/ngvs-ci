...
class InvoicingWashingMachineBlameJobBuilder extends AbstractWashingMachineBlameJobBuilder {
    ...
    protected void prepareParameters() {
        job.with {
            parameters {
                ...
                stringParam('DEFAULT_RECIPIENTS', 'invoicing_washingmachine@mailman.lmera.ericsson.se',
                        'Comma separated list of e-mail addresses that will always get the blame mail')
                stringParam('BLAME_CONFIG_FILE', '/proj/eta-automation/tapas/config/invoicing/config/blame/general-blame-config.json,' +
    ...
    protected String getIncludedPatterns() {
        return 'invoicingrpms/*.rpm, jive/*/*.jar'
    }
}
