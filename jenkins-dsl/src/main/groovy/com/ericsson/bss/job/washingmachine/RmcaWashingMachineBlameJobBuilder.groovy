...
class RmcaWashingMachineBlameJobBuilder extends AbstractWashingMachineBlameJobBuilder {
    ...
    protected void prepareParameters() {
        job.with {
            parameters {
                ...
                stringParam('DEFAULT_RECIPIENTS', 'gustav.fransson@ericsson.com',
                        'Comma separated list of e-mail addresses that will always get the blame mail')
                stringParam('BLAME_CONFIG_FILE', '/proj/eta-automation/tapas/config/rmca/config/blame/general-blame-config.json,' +
